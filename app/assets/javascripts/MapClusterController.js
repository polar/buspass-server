...
BusPass.MapClusterController = OpenLayers.Class( {
        ...
        protocol = new OpenLayers.Protocol.HTTP({
            ...
            callback : function(response) {
                ...
                if (response.features != null) {
                    ...
                    var feature = ctrl._setMapFeatures(route,response.features);
                    if (route.__highlighted) {
                        ctrl._highlightFeatures(route.__mapFeature);
                    }
    ...
    selectRouteNoTrigger : function(route) {
        ...
        this._selectFeatures(route.__mapFeature);
    ...
    unselectRouteNoTrigger : function(route) {
        ...
        this._unselectFeatures(route.__mapFeature);
    ...
    highlightRouteNoTrigger : function(route) {
        ...
        if (!route.isSelected()) {
            ...
            if (route.__mapFeature) {
                this._highlightFeatures(route.__mapFeature);
            } else {
    ...
    unhighlightRouteNoTrigger : function(route) {
        ...
        if (!route.isSelected()) {
            ...
            if (route.__mapFeature) {
                this._unhighlightFeatures(route.__mapFeature);
            }
    ...
    _setMapFeatures : function(route, features) {
        if (OpenLayers.Util.isArray(features)) {
            ...
            for (var i = 0; i < features.length; i++) {
                geometry.addComponent(features[i].geometry);
            }
            var attributes = [];
            var style = null;
            ...
            // Single Feature
            route.__mapFeature = features;
        }
        route.__mapFeature.__route = route;
    ...
    _constructVectorLayer : function() {
        ...
        ctrl.defaultStyle.addRules([strokeWidth,
        ...
        var clusterStrategy = new BusPass.RouteFeatureCluster();
    ...
    _setupSelectControls : function (layers) {
        ...
        ctrl._selectCtrl = new BusPass.SelectAllFeature(layers, {
                scope: ctrl,
                multiple: false,
...
BusPass.MapClusterController.SelectControl = OpenLayers.Class(OpenLayers.Control.SelectFeature, {
    /**
    ...
    */
    ...
    CLASS_NAME: "BusPass.MapClusterController.SelectControl"
});
